...
type TektonConfigSpec struct {
	...
	// This field is propagated to TektonTrigger, TektonPipeline, and TektonPruner,
	// which are the components with NetworkPolicy reconciliation implemented.
	// Other components (Chains, Results, Dashboard) do not yet act on this field.
	// +optional
