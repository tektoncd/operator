...
type TektonConfigSpec struct {
	...
	// This field is propagated to TektonTrigger, TektonPipeline, and TektonResult,
	// which implement NetworkPolicy reconciliation. Other components (Chains,
	// Dashboard) do not yet act on this field.
	// +optional
