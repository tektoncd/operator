...
func TestTektonChainsGroupVersionKind(t *testing.T) {
	r := &TektonChains{}
	want := schema.GroupVersionKind{
		Group:   GroupName,
		Version: SchemaVersion,
		Kind:    KindTektonChains,
	}
...
func TestTektonChainsHappyPath(t *testing.T) {
	tt := &TektonChainsStatus{}
...
func TestTektonChainsErrorPath(t *testing.T) {
	tr := &TektonChainsStatus{}
...
func TestTektonChainsExternalDependency(t *testing.T) {
	tt := &TektonChainsStatus{}
	tt.InitializeConditions()
