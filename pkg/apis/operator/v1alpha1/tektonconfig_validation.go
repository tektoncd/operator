...
func (tc *TektonConfig) Validate(ctx context.Context) (errs *apis.FieldError) {
	...
	if IsOpenShiftPlatform() && tc.Spec.Platforms.OpenShift != nil && tc.Spec.Platforms.OpenShift.NamespaceSync != nil {
...
func isOpenShiftPlatformsSectionSet(o *OpenShift) bool {
	return o != nil && (o.PipelinesAsCode != nil || o.SCC != nil || o.NamespaceSync != nil)
}
