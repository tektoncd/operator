...
var log = logf.Log.WithName("controller_addon")
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &operatorv1alpha1.Addon{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &operatorv1alpha1.Addon{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileAddon) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	reqLogger := log.WithValues("Request.Namespace", request.Namespace, "Request.Name", request.Name)
	reqLogger.Info("Reconciling Addon")

	// Fetch the Addon instance
	instance := &operatorv1alpha1.Addon{}
	...
	// Set Addon instance as the owner and controller
...
func newPodForCR(cr *operatorv1alpha1.Addon) *corev1.Pod {
