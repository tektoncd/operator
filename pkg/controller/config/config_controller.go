...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &operatorv1alpha1.Config{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &operatorv1alpha1.Config{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileConfig) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &operatorv1alpha1.Config{}
...
func newPodForCR(cr *operatorv1alpha1.Config) *corev1.Pod {
