...
var tektoninstallersetsResource = v1alpha1.SchemeGroupVersion.WithResource("tektoninstallersets")

var tektoninstallersetsKind = v1alpha1.SchemeGroupVersion.WithKind("TektonInstallerSet")
