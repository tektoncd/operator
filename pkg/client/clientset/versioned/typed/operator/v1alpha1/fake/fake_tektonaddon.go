...
var tektonaddonsResource = v1alpha1.SchemeGroupVersion.WithResource("tektonaddons")

var tektonaddonsKind = v1alpha1.SchemeGroupVersion.WithKind("TektonAddon")

// Get takes name of the tektonAddon, and returns the corresponding tektonAddon object, and an error if there is any.
func (c *FakeTektonAddons) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TektonAddon, err error) {
	obj, err := c.Fake.
...
func (c *FakeTektonAddons) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TektonAddonList, err error) {
	obj, err := c.Fake.
...
func (c *FakeTektonAddons) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeTektonAddons) Create(ctx context.Context, tektonAddon *v1alpha1.TektonAddon, opts v1.CreateOptions) (result *v1alpha1.TektonAddon, err error) {
	obj, err := c.Fake.
...
func (c *FakeTektonAddons) Update(ctx context.Context, tektonAddon *v1alpha1.TektonAddon, opts v1.UpdateOptions) (result *v1alpha1.TektonAddon, err error) {
	obj, err := c.Fake.
...
func (c *FakeTektonAddons) UpdateStatus(ctx context.Context, tektonAddon *v1alpha1.TektonAddon, opts v1.UpdateOptions) (*v1alpha1.TektonAddon, error) {
	obj, err := c.Fake.
...
func (c *FakeTektonAddons) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(tektonaddonsResource, listOpts)
...
func (c *FakeTektonAddons) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TektonAddon, err error) {
	obj, err := c.Fake.
