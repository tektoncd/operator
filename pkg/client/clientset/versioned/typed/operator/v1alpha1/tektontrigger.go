...
type TektonTriggerInterface interface {
	Create(*v1alpha1.TektonTrigger) (*v1alpha1.TektonTrigger, error)
	Update(*v1alpha1.TektonTrigger) (*v1alpha1.TektonTrigger, error)
	UpdateStatus(*v1alpha1.TektonTrigger) (*v1alpha1.TektonTrigger, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.TektonTrigger, error)
	List(opts v1.ListOptions) (*v1alpha1.TektonTriggerList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.TektonTrigger, err error)
...
func (c *tektonTriggers) Get(name string, options v1.GetOptions) (result *v1alpha1.TektonTrigger, err error) {
...
func (c *tektonTriggers) List(opts v1.ListOptions) (result *v1alpha1.TektonTriggerList, err error) {
...
func (c *tektonTriggers) Watch(opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tektonTriggers) Create(tektonTrigger *v1alpha1.TektonTrigger) (result *v1alpha1.TektonTrigger, err error) {
	result = &v1alpha1.TektonTrigger{}
	err = c.client.Post().
		Resource("tektontriggers").
		Body(tektonTrigger).
...
func (c *tektonTriggers) Update(tektonTrigger *v1alpha1.TektonTrigger) (result *v1alpha1.TektonTrigger, err error) {
	result = &v1alpha1.TektonTrigger{}
	err = c.client.Put().
		Resource("tektontriggers").
...
func (c *tektonTriggers) UpdateStatus(tektonTrigger *v1alpha1.TektonTrigger) (result *v1alpha1.TektonTrigger, err error) {
	result = &v1alpha1.TektonTrigger{}
	err = c.client.Put().
		Resource("tektontriggers").
		Name(tektonTrigger.Name).
...
func (c *tektonTriggers) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *tektonTriggers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tektonTriggers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.TektonTrigger, err error) {
	result = &v1alpha1.TektonTrigger{}
