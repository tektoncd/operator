...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.OpenShiftPipelinesAsCode, desiredFinalizers sets.Set[string]) (*v1alpha1.OpenShiftPipelinesAsCode, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.OpenShiftPipelinesAsCode, desiredFinalizers sets.Set[string]) (*v1alpha1.OpenShiftPipelinesAsCode, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.OpenShiftPipelinesAsCode, desiredFinalizers sets.Set[string]) (*v1alpha1.OpenShiftPipelinesAsCode, error) {
	// Don't modify the informers copy.
