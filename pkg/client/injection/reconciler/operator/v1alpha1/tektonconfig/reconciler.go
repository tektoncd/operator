...
// controller finalizing v1alpha1.TektonConfig if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1alpha1.TektonConfig.
	// This method should not write to the API.
	//
	// Deprecated: Use reconciler.ObserveDeletion instead.
	ObserveFinalizeKind(ctx context.Context, o *v1alpha1.TektonConfig) reconciler.Event
}
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.TektonConfig, desired *v1alpha1.TektonConfig) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.TektonConfig) (*v1alpha1.TektonConfig, error) {
