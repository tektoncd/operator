...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.TektonConfig, desiredFinalizers sets.String) (*v1alpha1.TektonConfig, error) {
	// Don't modify the informers copy.
