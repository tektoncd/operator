...
import (
	...
	tektonconfig "github.com/tektoncd/operator/pkg/client/injection/informers/operator/v1alpha1/tektonconfig"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "tektonconfig-controller"
	defaultFinalizerName       = "tektonconfigs.operator.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := tektonconfigInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.tekton.dev.TektonConfig"),
	)
