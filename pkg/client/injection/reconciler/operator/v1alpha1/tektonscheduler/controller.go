...
const (
	defaultControllerAgentName = "tektonscheduler-controller"
	defaultFinalizerName       = "tektonschedulers.operator.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	tektonschedulerInformer := tektonscheduler.Get(ctx)

	lister := tektonschedulerInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.tekton.dev.TektonScheduler"),
	)
