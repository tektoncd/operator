...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.TektonChain, desiredFinalizers sets.String) (*v1alpha1.TektonChain, error) {
	// Don't modify the informers copy.
