...
import (
	...
	shipwrightbuild "github.com/tektoncd/operator/pkg/client/injection/informers/operator/v1alpha1/shipwrightbuild"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "shipwrightbuild-controller"
	defaultFinalizerName       = "shipwrightbuilds.operator.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	shipwrightbuildInformer := shipwrightbuild.Get(ctx)

	lister := shipwrightbuildInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.tekton.dev.ShipwrightBuild"),
	)
