...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.TektonInstallerSet, desiredFinalizers sets.String) (*v1alpha1.TektonInstallerSet, error) {
	// Don't modify the informers copy.
