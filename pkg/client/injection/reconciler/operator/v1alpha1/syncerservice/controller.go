...
import (
	...
	syncerservice "github.com/tektoncd/operator/pkg/client/injection/informers/operator/v1alpha1/syncerservice"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "syncerservice-controller"
	defaultFinalizerName       = "syncerservices.operator.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	syncerserviceInformer := syncerservice.Get(ctx)

	lister := syncerserviceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.tekton.dev.SyncerService"),
	)
