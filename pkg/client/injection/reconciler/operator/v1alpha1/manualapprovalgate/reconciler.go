...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ManualApprovalGate, desiredFinalizers sets.String) (*v1alpha1.ManualApprovalGate, error) {
	// Don't modify the informers copy.
