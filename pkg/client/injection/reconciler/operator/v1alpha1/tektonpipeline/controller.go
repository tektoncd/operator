...
import (
	...
	tektonpipeline "github.com/tektoncd/operator/pkg/client/injection/informers/operator/v1alpha1/tektonpipeline"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "tektonpipelines.operator.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.tekton.dev.TektonPipeline"),
	)
