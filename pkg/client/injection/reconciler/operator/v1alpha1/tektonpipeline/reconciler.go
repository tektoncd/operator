...
// controller reconciling v1alpha1.TektonPipeline if they want to process resources for which
// they are not the leader.
type ReadOnlyInterface interface {
	// ObserveKind implements logic to observe v1alpha1.TektonPipeline.
	// This method should not write to the API.
	ObserveKind(ctx context.Context, o *v1alpha1.TektonPipeline) reconciler.Event
}

type doReconcile func(ctx context.Context, o *v1alpha1.TektonPipeline) reconciler.Event
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.TektonPipeline, desired *v1alpha1.TektonPipeline) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.TektonPipeline, desiredFinalizers sets.Set[string]) (*v1alpha1.TektonPipeline, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.TektonPipeline, desiredFinalizers sets.Set[string]) (*v1alpha1.TektonPipeline, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.TektonPipeline, desiredFinalizers sets.Set[string]) (*v1alpha1.TektonPipeline, error) {
	// Don't modify the informers copy.
