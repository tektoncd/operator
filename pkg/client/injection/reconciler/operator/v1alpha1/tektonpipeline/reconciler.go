...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.TektonPipeline, desiredFinalizers sets.String) (*v1alpha1.TektonPipeline, error) {
	// Don't modify the informers copy.
