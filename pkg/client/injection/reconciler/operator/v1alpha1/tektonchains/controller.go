...
import (
	...
	tektonchains "github.com/tektoncd/operator/pkg/client/injection/informers/operator/v1alpha1/tektonchains"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "tektonchains-controller"
	defaultFinalizerName       = "tektonchainses.operator.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	tektonchainsInformer := tektonchains.Get(ctx)

	lister := tektonchainsInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.tekton.dev.TektonChains"),
	)
