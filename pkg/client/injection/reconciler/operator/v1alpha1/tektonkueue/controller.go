...
import (
	...
	tektonkueue "github.com/tektoncd/operator/pkg/client/injection/informers/operator/v1alpha1/tektonkueue"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "tektonkueue-controller"
	defaultFinalizerName       = "tektonkueues.operator.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	tektonkueueInformer := tektonkueue.Get(ctx)

	lister := tektonkueueInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.tekton.dev.TektonKueue"),
	)
