...
import (
	...
	tektonaddon "github.com/tektoncd/operator/pkg/client/injection/informers/operator/v1alpha1/tektonaddon"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "tektonaddon-controller"
	defaultFinalizerName       = "tektonaddons.operator.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	tektonaddonInformer := tektonaddon.Get(ctx)

	lister := tektonaddonInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.tekton.dev.TektonAddon"),
	)
