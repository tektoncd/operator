...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.TektonAddon, desiredFinalizers sets.String) (*v1alpha1.TektonAddon, error) {
	// Don't modify the informers copy.
