...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.TektonPruner, desiredFinalizers sets.Set[string]) (*v1alpha1.TektonPruner, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.TektonPruner, desiredFinalizers sets.Set[string]) (*v1alpha1.TektonPruner, error) {
	// Don't modify the informers copy.
