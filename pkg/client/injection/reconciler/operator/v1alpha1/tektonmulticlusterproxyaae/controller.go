...
import (
	...
	tektonmulticlusterproxyaae "github.com/tektoncd/operator/pkg/client/injection/informers/operator/v1alpha1/tektonmulticlusterproxyaae"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "tektonmulticlusterproxyaae-controller"
	defaultFinalizerName       = "tektonmulticlusterproxyaaes.operator.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	tektonmulticlusterproxyaaeInformer := tektonmulticlusterproxyaae.Get(ctx)

	lister := tektonmulticlusterproxyaaeInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.tekton.dev.TektonMulticlusterProxyAAE"),
	)
