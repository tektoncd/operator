...
import (
	...
	tektontrigger "github.com/tektoncd/operator/pkg/client/injection/informers/operator/v1alpha1/tektontrigger"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "tektontrigger-controller"
	defaultFinalizerName       = "tektontriggers.operator.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	tektontriggerInformer := tektontrigger.Get(ctx)

	lister := tektontriggerInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.tekton.dev.TektonTrigger"),
	)
