...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.TektonTrigger, desiredFinalizers sets.String) (*v1alpha1.TektonTrigger, error) {
	// Don't modify the informers copy.
