...
import (
	...
	sharedresource "github.com/tektoncd/operator/pkg/client/injection/informers/operator/v1alpha1/sharedresource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "sharedresource-controller"
	defaultFinalizerName       = "sharedresources.operator.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	sharedresourceInformer := sharedresource.Get(ctx)

	lister := sharedresourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.tekton.dev.SharedResource"),
	)
