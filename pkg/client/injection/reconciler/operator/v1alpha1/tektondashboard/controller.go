...
import (
	...
	tektondashboard "github.com/tektoncd/operator/pkg/client/injection/informers/operator/v1alpha1/tektondashboard"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "tektondashboard-controller"
	defaultFinalizerName       = "tektondashboards.operator.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	tektondashboardInformer := tektondashboard.Get(ctx)

	lister := tektondashboardInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.tekton.dev.TektonDashboard"),
	)
