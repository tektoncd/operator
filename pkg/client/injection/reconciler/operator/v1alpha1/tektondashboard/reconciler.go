...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.TektonDashboard, desiredFinalizers sets.String) (*v1alpha1.TektonDashboard, error) {
	// Don't modify the informers copy.
