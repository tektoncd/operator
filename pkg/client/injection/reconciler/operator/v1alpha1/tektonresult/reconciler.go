...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.TektonResult, desiredFinalizers sets.String) (*v1alpha1.TektonResult, error) {
	// Don't modify the informers copy.
