...
func Get(ctx context.Context, selector string) v1alpha1.OpenShiftPipelinesAsCodeInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/tektoncd/operator/pkg/client/informers/externalversions/operator/v1alpha1.OpenShiftPipelinesAsCodeInformer with selector %s from context.", selector)
	}
