...
func NewTektonPrunerLister(indexer cache.Indexer) TektonPrunerLister {
	return &tektonPrunerLister{listers.New[*operatorv1alpha1.TektonPruner](indexer, operatorv1alpha1.Resource("tektonpruner"))}
}
