...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("sharedresources"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Operator().V1alpha1().SharedResources().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("shipwrightbuilds"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Operator().V1alpha1().ShipwrightBuilds().Informer()}, nil
	...
	case v1alpha1.SchemeGroupVersion.WithResource("tektonkueues"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Operator().V1alpha1().TektonKueues().Informer()}, nil
