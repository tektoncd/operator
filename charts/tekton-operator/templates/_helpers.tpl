...
{{- else -}}
{{- if .Values.openshift.enabled -}}
  {{- $image = "ghcr.io/tekton-releases/github.com/tektoncd/operator/cmd/openshift/operator" -}}
{{- else -}}
  {{- $image = "ghcr.io/tekton-releases/github.com/tektoncd/operator/cmd/kubernetes/operator" -}}
{{- end -}}
{{- end -}}
...
{{- else -}}
{{- if .Values.openshift.enabled -}}
  {{- $image = "ghcr.io/tekton-releases/github.com/tektoncd/operator/cmd/openshift/webhook" -}}
{{- else -}}
  {{- $image = "ghcr.io/tekton-releases/github.com/tektoncd/operator/cmd/kubernetes/webhook" -}}
{{- end -}}
{{- end -}}
{{- printf "%s:%s" $image $tag -}}
{{- end -}}
...
{{- else -}}
{{- if .Values.openshift.enabled -}}
  {{- $image = "ghcr.io/tekton-releases/github.com/tektoncd/operator/cmd/openshift/proxy-webhook" -}}
{{- else -}}
  {{- $image = "ghcr.io/tekton-releases/github.com/tektoncd/operator/cmd/kubernetes/proxy-webhook" -}}
{{- end -}}
{{- end -}}
{{- printf "%s:%s" $image $tag -}}
{{- end -}}
