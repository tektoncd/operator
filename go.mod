...
require (
	...
	github.com/tektoncd/pipeline v0.47.6
...
// to make the new cosign v2.2.2 work with old deps
replace (
	github.com/buildkite/agent/v3 => github.com/buildkite/agent/v3 v3.45.0
	github.com/letsencrypt/boulder => github.com/letsencrypt/boulder v0.0.0-20221109233200-85aa52084eaf
